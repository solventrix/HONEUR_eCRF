...
class SCT(models.EpisodeSubrecord):
    ...
    sct_type = fields.CharField(max_length = 12, verbose_name = _("Type of SCT"), choices = SCTTypes, null = True)
...
class PatientDetails(models.PatientSubrecord):
    ...
    status = fields.CharField(max_length = 100, choices = statuses, verbose_name = _("Patient Status"))
    ...
    pp_type_choices = [('IgG', 'IgG'),('IgA', 'IgA'),('IgE', 'IgE'),('LCM', 'Light Chain Myeloma') ] 

    diag_date = fields.DateField(blank = False, null = True, verbose_name = _('Date of Diagnosis'))
    smm_history = fields.CharField(max_length = 10, choices = choices, verbose_name = _("History of SMM"))
    smm_history_date = fields.DateField(null = True, verbose_name = _("Date of SMM diagnosis"))
    mgus_history = fields.CharField(max_length = 10, choices = choices, verbose_name = _("History of MGUS"))
    mgus_history_date = fields.DateField(null=True, verbose_name = _("Date of MGUS Diagnosis"))
    r_iss_stage = fields.CharField(max_length = 10, choices = r_iss_stages, verbose_name = _('R-ISS Stage'))
    pp_type = fields.CharField(max_length = 50, choices = pp_type_choices, verbose_name = 'PP Type')
...
class Regimen(models.EpisodeSubrecord):
    ...
    nbCycles = fields.IntegerField(verbose_name = _('Number of Cycles'), null = True, blank = True, validators = [validate_positive])
    start_date = fields.DateField(verbose_name = _('Start Date'), validators = [validate_emptystring])
