...
def new_patient_and_episode_please(category="MM"):
...
def create_complex_mm_patient():
    ...
    diagnosis_details.smm_history = "No"
    ...
    followup = episode.mmfollowup_set.create()
    followup.follow_up_date = today - datetime.timedelta(40)
    followup.hospital = "MVZ Koln"
    followup.LDH = 20
    followup.beta2m = 10
    followup.albumin = 10
    followup.mprotein_urine = 10
    followup.mprotein_serum = 10
    followup.mprotein_24h = 10
    followup.consistency_token = "1231123"
    followup.save()
    return patient, episode


def create_no_gender_mm_patient():
    patient, _ = create_complex_mm_patient()
    demographics = patient.demographics_set.get()
    demographics.sex = ""
    demographics.save()


def create_complex_cll_patient():
    patient, episode = new_patient_and_episode_please("CLL")
    today = datetime.date.today()
    demographics = patient.demographics_set.get()
    demographics.hospital_number = "1231231"
    demographics.date_of_birth = datetime.date(1993, 2, 4)
    ...
    diagnosis_details.diag_date = today - datetime.timedelta(40)
    # diagnosis_details.binet_stage = "Stage A"
    diagnosis_details.consistency_token = "1231123"
    diagnosis_details.save()

    lot_episode = patient.create_episode(category_name="Treatment Line")

    cll_regimen = lot_episode.cllregimen_set.create()
    cll_regimen.hospital = "MVZ Koln"
    cll_regimen.start_date = today - datetime.timedelta(35)
    cll_regimen.category = "Treatment"
    cll_regimen.regimen = "Chlorambucil.Obinotuzumab"
    cll_regimen.nbCycles = 4
    cll_regimen.consistency_token = "1231123"
    cll_regimen.save()

    response = lot_episode.bestresponse_set.create()
    response.response_date = today - datetime.timedelta(30)
    response.response = "Stable Disease"
    response.consistency_token = "1231123"
    response.save()

    additional_characteristics = episode.additionalcharacteristics_set.create()
    additional_characteristics.characteristic_date = today - datetime.timedelta(30)
    additional_characteristics.beta2m = 1
    additional_characteristics.ecog_score = 1
    additional_characteristics.cirs_score = 1
    additional_characteristics.cirs_score = 1
    additional_characteristics.LDH = 1
    additional_characteristics.bulky_disease = "Yes"
    ...
    additional_characteristics = episode.additionalcharacteristics_set.create()
    additional_characteristics.characteristic_date = today - datetime.timedelta(30)
    additional_characteristics.beta2m = 5
    additional_characteristics.ecog_score = 5
    additional_characteristics.cirs_score = 5
    additional_characteristics.cirs_score = 5
    additional_characteristics.LDH = 5
    additional_characteristics.bulky_disease = "Yes"
    additional_characteristics.save()
    ...
    cytogenetics = episode.cytogenetics_set.create()
    cytogenetics.cytogenetic_date = today - datetime.timedelta(20)
    cytogenetics.del17p = "Yes"
    cytogenetics.ighv_rearrangement = "Mutated"
    cytogenetics.del11q = "Yes"
    cytogenetics.tp53_mutation = "Yes"
    cytogenetics.karyotype = "Yes"
    cytogenetics.save()
    ...
    qualityoflife5q = episode.qualityoflife5q_set.create()
    qualityoflife5q.q5_date = today - datetime.timedelta(20)
    qualityoflife5q.q5_mobility = 1
    qualityoflife5q.q5_selfcare = 1
    qualityoflife5q.q5_usual_activities = 1
    qualityoflife5q.q5_pain_discomfort = 1
    qualityoflife5q.q5_anxiety_depression = 1
    qualityoflife5q.save()

    qualityoflife5q = episode.qualityoflife5q_set.create()
    qualityoflife5q.q5_date = today - datetime.timedelta(30)
    qualityoflife5q.q5_mobility = 3
    qualityoflife5q.q5_selfcare = 3
    qualityoflife5q.q5_usual_activities = 3
    qualityoflife5q.q5_pain_discomfort = 3
    qualityoflife5q.q5_anxiety_depression = 3
    qualityoflife5q.save()

    qualityoflife5q = episode.qualityoflife5q_set.create()
    qualityoflife5q.q5_date = today - datetime.timedelta(30)
    qualityoflife5q.q5_mobility = 2
    qualityoflife5q.q5_selfcare = 2
    qualityoflife5q.q5_usual_activities = 2
    qualityoflife5q.q5_pain_discomfort = 2
    qualityoflife5q.q5_anxiety_depression = 2
    qualityoflife5q.save()

    return patient, episode


def create_no_diag_date_cll():
    patient, _ = create_complex_cll_patient()
...
def future_death():
    ...
    cytogenetics = episode.mmcytogenetics_set.create()
    cytogenetics.cytogenetic_date = today - datetime.timedelta(80)
    cytogenetics.hospital = "MVZ Koln"
    cytogenetics.tp_53 = "Negative"
    ...
    cytogenetics = episode.mmcytogenetics_set.create()
    cytogenetics.cytogenetic_date = today - datetime.timedelta(90)
    cytogenetics.hospital = "MVZ Koln"
    cytogenetics.tp_53 = "Negative"
    cytogenetics.del_17p = "Positive"
    cytogenetics.del11q = "Positive"
    ...
    cytogenetics = episode.mmcytogenetics_set.create()
    cytogenetics.cytogenetic_date = today - datetime.timedelta(100)
    cytogenetics.hospital = "MVZ Koln"
    cytogenetics.tp_53 = "Negative"
    cytogenetics.del_17p = "Positive"
    cytogenetics.del11q = "Positive"
...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        for i in range(10):
            create_complex_mm_patient()
        # create_no_gender_mm_patient()
        for i in range(10):
            create_complex_cll_patient()
        # for i in range(10):
        #     create_complex_mm_patient()
        # create_no_gender_mm_patient()
        # for i in range(10):
