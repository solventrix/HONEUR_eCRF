describe("Validators", function () {
  "use strict";
	...
	describe('validateRegimenToOtherLOTRegimens', function(){
		...
		it('should return true if the other episodes have regimen with no start or end date', function(){
			episode.id = 2
			var episode_2 = {
				id: 3
			}
		...
		it('should return true if episodes regimen have no start or end date', function(){
			episode.id = 2
			var episode_2 = {
				id: 3
			}
		...
		it('should return false if there is only an end date and the episode surrounds it', function(){
			episode.id = 2
			var episode_2 = {
				id: 3
			}
			...
			patient.episodes = [episode, episode_2];
			spyOn(EntrytoolHelper, 'getEpisodeRegimen').and.returnValues([regimen_2], [regimen_1, regimen_3]);
			expect(Validators.validateRegimenToOtherLOTRegimens(regimen_2.end_date, regimen_2, episode, patient)).toBe(false);
		});

		it('should return false if there is only an end date on one of the other episodes that surround it', function(){
			episode.id = 2
			var episode_2 = {
				id: 3
			}
		...
		it('should return false if there is only an start date on one of the other episodes that surround it', function(){			episode.id = 2
			var episode_2 = {
				id: 3
			}
			var regimen_1 = {
