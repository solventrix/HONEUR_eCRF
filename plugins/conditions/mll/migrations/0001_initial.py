# Generated by Django 2.0.13 on 2022-02-17 21:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_mll_mlldiagnosisdetails_subrecords', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ...
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='updated_mll_mlldiagnosisdetails_subrecords', to=settings.AUTH_USER_MODEL, verbose_name='Updated By')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospital_ft', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_mll_mllfollowup_subrecords', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('hospital_fk', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='entrytool.Hospital')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='opal.Patient', verbose_name='Patient')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='updated_mll_mllfollowup_subrecords', to=settings.AUTH_USER_MODEL, verbose_name='Updated By')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_mll_mllregimen_subrecords', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'MLL Regimen List',
                'verbose_name_plural': 'MLL Regimen List',
            },
        ),
        migrations.CreateModel(
            name='MLLResponse',
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_mll_mllresponse_subrecords', to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
                ('episode', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='opal.Episode', verbose_name='Episode')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='updated_mll_mllresponse_subrecords', to=settings.AUTH_USER_MODEL, verbose_name='Updated By')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'MLL Stop Reason List',
                'verbose_name_plural': 'MLL Stop Reason List',
            },
        ),
        migrations.AddField(
            model_name='mllregimen',
            name='regimen_fk',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='mll.MLLRegimenList'),
        ),
        migrations.AddField(
            model_name='mllregimen',
            name='stop_reason_fk',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='mll.MLLStopReason'),
        ),
        migrations.AddField(
            model_name='mllregimen',
            name='updated_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='updated_mll_mllregimen_subrecords', to=settings.AUTH_USER_MODEL, verbose_name='Updated By'),
        ),
    ]
